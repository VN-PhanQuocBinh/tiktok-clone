...
const Icon_UserArrowRegular = (props) => {
   return (
      <svg
         ...
         fill="currentColor"
      >
         <use xlink:href="#person_arrow_left_fill-a2d06cac"></use>
      </svg>
   );
};
...
const Icon_PlusSolid = (props) => {
   return (
      <FontAwesomeIcon icon={faSquarePlus} {...props} />
   );
};

const Icon_PlusRegular = (props) => {
   return (
      <FontAwesomeIcon icon={faSquarePlusRegular} {...props} />
   );
};
